...
#Centralised Function to write gowtham (To be connected to main code soon)
def Audit(Text_message):
    with open("gowtham.json") as f:
        contents = json.load(f)
        Dev = contents["DeveloperTools"]
        Audfile = open("gowtham.txt", "a")
    if Dev == "off":
...
#Function to get weather when starting gowtham
def Weather(timeing):
    try:
        with open("gowtham.json") as f:
            contents = json.load(f)
        ...
        if x["cod"] != "404":
            ...
            print("gowtham: Please check your city in the settings as this is invalid.")
            Audit("--> ERROR 801, User's City Is Invalid. Please Try Again.")
    except:
        print("gowtham: I am having a problem in getting live weather please check your internet-connection.")
        Audit("--> ERROR 805: Connection Failed with OpenWeatherMap. Please Check your Connection.")


#Function to get location when starting gowtham
def location():
    #initialize the object
    Nomi_locator = Nominatim(user_agent="gowtham")
...
def Breifing(title):
    ...
    if title == 'Morning Briefing':
        try:
            ...
            print("gowtham: Something went wrong!!!" +
                  "\ngowtham: Please check if you have a good \ninternet connection and have given a valid \ncategory and location.")
...
def Settings():
    ...
    layout = [[sg.Text('Settings', font='Default 16')],
              ...
              [sg.Text('Saving will close gowtham For the Data To Refresh.', font='Default 10')],
    ...
    while True:  # Event Loop
        ...
        if event == 'Save':
            ...
            with open("gowtham.json", "w") as outfile:
...
def send_an_email(from_address, to_address, subject, message_text, password):
    try:
        gowtham_mail = '\n \n \n \n                                                        ---This message was sent to you by gowtham  :-)'
        full_message = "{0} {1}".format(message_text, gowtham_mail)
...
def Help():
    sg.popup_scrolled("""Welcome to the Help Centre
            1. Setting up gowtham: -----------
            gowtham have the ability to chat once installed by default.
            ...
            (when always entering gowtham)
            so please enter your city's name.
            Example: Singapore, New york, Delhi, Dubai, London, Sydney

            2. Commands to run gowtham: ------------
            To make gowtham respond Users will need to enter a Command
            in the input for which gowtham will scan for keywords
...
def Error():
    sg.popup("""
Whenever gowtham runs into some unforseen or unexpected problems or circumstances an error code will be written down
on gowtham.txt so that users or developers testing would know what went wrong.
...
3. Error 805: When gowtham couldn't connect to OpenWeatherMap Please check your Internet connection.
...
window = sg.Window('J.A.R.V.I.S GUI', layout, location=(0, 0), icon=r'icon/gowtham.ico', font=(
    'Helvetica', ' 13'), default_button_element_size=(8, 2)).Finalize()
window.maximize()


hour = int(datetime.datetime.now().hour)
Audit("--> USER ACTIVATED gowtham AND INITIALIZED RELATED PROCESSES!!!")
if hour >= 0 and hour < 12:
    timeing = "gowtham: Good Morning Sir, here is the current weather in "
    location()
    Weather(timeing)
    Breifing('Morning Briefing')
elif hour >= 12 and hour < 18:
    timeing = "gowtham: Good Afternoon Sir, here is the current weather in "
    location()
    Weather(timeing)
else:
    timeing = "gowtham: Good Evening Sir, here is the current weather in "
    location()
    Weather(timeing)
...
if __name__ == '__main__':
    while True:     # The Infinity Event Loop
        ...
        if event in (sg.WIN_CLOSED, 'Exit'):   # quit if exit button or X
            print("\ngowtham: Goodbye sir hope you have a nice day :-)")
            print("\nJ.A.R.V.I.S Copyright (C) 2024 Epicalable LLC. All Rights Reserved.")
            Audit("--> USER TERMINATED gowtham AND ALL IT'S RELATED PROCESSES!!!")
            time.sleep(4)
            break
                ...
                with open("Jarintents.json") as f:
                    ...
                    # THE END OF THE RENDER-WORD ENGINE (C) Epicalable
                        ...
                        if "STOCK " in query or "STOCK PRICE" in query:
                            ...
                            print("gowtham: The Date and Time is ",
                                  x, " respectively sir.")
                            continue
                            ...
                            try:
                                ...
                                print("gowtham: I am having a problem in getting wikipedia please check your internet-connection.")
                            ...
                            try:
                                ...
                                print(
                                    "gowtham: I am having a problem in getting wikipedia please check your internet-connection")
                                Audit("--> ERROR 500: Failed To Establish Connection With Wikipedia.")
                            continue
                            ...
                            try:
                                ...
                                print("gowtham: Something went wrong please check if you have a good internet connection.")
                            ...
                            print("gowtham: Taking you to NASA's Eyes Planet tracker.")
                            ...
                            print("gowtham: Taking you to NASA's Eyes Asteroid tracker.")
                            Audit("-USER went to a NASA website.")
                            time.sleep(3)
                            ...
                            print("gowtham: Taking you to NASA's Eyes Solar System.")
                            Audit("- USER went to a NASA website.")
                            time.sleep(3)
                            ...
                            print("gowtham: Taking you to NASA's Eyes Exoplanets.")
                            Audit("- USER went to a NASA website.")
                            time.sleep(3)
                            ...
                            print("gowtham: Goodbye sir hope you have a nice day :-)")
                            print("\nJ.A.R.V.I.S Copyright (C) 2024 Epicalable LLC. All Rights Reserved.")
                            Audit("--> USER TERMINATED gowtham AND ALL IT'S RELATED PROCESSES!!! \n")
                            time.sleep(4)
                            window.close()
                            ...
                            print("gowtham: Sorry sir unfortunately I couldn't process what you were trying to say.")
                            ...
                            print("Feel free to head to Epicalable's Github page and create an issue in gowtham Repository")
        ...
        #Following functions is on the taskbar/menu panel on top
            ...
            sg.popup_no_titlebar("Please star our 'gowtham-GUI' github repository and also",
                                 "Subscribe and share our 'Epicalable' Youtube channel")
            webbrowser.open("https://github.com/Epicalable/gowtham", new=1)
            ...
            webbrowser.open(
                "https://github.com/Epicalable/gowtham-GUI/issues", new=1)
